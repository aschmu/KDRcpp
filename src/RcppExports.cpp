...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(kdr_linesearch_cpp(X, Ky, sz2, B, dB, eta, eps, tol));
    return __result;
END_RCPP
}
// kdr_trace_cpp
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    __result = Rcpp::wrap(kdr_trace_cpp(X, Y, K, max_loop, sigmax0, sigmay0, eps, eta, anl, verbose, tol));
    return __result;
END_RCPP
}
// centerMatrix
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::mat& >::type X(XSEXP);
    __result = Rcpp::wrap(centerMatrix(X));
    return __result;
END_RCPP
}
// distSquared
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(distSquared(A, B));
    return __result;
END_RCPP
}
// RBFdot
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(RBFdot(X, Y, sigma));
    return __result;
END_RCPP
}
